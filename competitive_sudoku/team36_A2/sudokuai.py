...
class SudokuAI(competitive_sudoku.sudokuai.SudokuAI):
    ...
    def compute_best_move(self, game_state: GameState) -> None:
        ...
        def minimax(game_state: GameState, depth: int, alpha: float, beta: float, isMaximisingPlayer: bool,
                    current_score: int, empty_squares: list, all_moves: list, initial=False, taboo=False):
            """
            ...
            if isMaximisingPlayer:
                ...
                for move in all_moves:
                    ...
                    current_eval = \
                    minimax(game_state, depth - 1, alpha, beta, False, current_score, empty_squares, new_moves,
                            taboo=taboo)[1]
                ...
                for move in all_moves:
                    ...
                    current_eval = \
                    minimax(game_state, depth - 1, alpha, beta, True, current_score, empty_squares, new_moves,
                            taboo=taboo)[1]
    ...
    def propose_taboo_move(self, eval, empty_squares):
        ...
        # If you are play on the oneven (winning) side, but there is one taboo move left
            ...
            alternative_moves = [move for eval, move in self.last_moves if
                                 (move.i == taboo_move.i) and (move.j == taboo_move.j) and (
